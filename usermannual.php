...
<main class="flex-1 p-8">
    ...
    <section class="bg-white p-6 rounded-xl shadow-2xl">
        ...
        <div class="h-[70vh] min-h-[500px] w-full">
             <object data="./uploads/G10_Manual_2.pdf" type="application/pdf" width="100%" height="100%" class="border rounded-lg shadow-inner">
                <div class="p-8 text-center bg-red-50 border border-red-200 rounded-lg">
                    ...
                    <a href="./uploads/G10_Manual_2.pdf" target="_blank" class="mt-4 inline-block bg-blue-600 text-white px-6 py-2 rounded-lg hover:bg-blue-700 transition duration-150">
